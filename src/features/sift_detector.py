...
ALLOWED_PARAMS = {"nfeatures", "nOctaveLayers", "contrastThreshold", "edgeThreshold", "sigma"}
...
class SIFTDetector(BaseDetector):
    def __init__(self, **params):
        ...
        if bad_keys:
            raise ValueError(f"Unknown SIFT parameters: {bad_keys}")
        self._detector = cv2.SIFT_create(**params)
